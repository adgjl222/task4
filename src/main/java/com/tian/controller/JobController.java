...
public class JobController {
    ...
    public ModelAndView testDeleteJob(Integer id){
        jobService.deleteByPrimaryKey(id);
        String direction = jobService.selectById(id);
        List<Job> jobList = jobService.selectByDirection(direction);
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.addObject("jobList",jobList);
        modelAndView.setViewName("redirect:/listjob");
        return  modelAndView;
    }
